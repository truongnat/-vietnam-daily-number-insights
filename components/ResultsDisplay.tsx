  ...
  return (
    <div className="w-full max-w-6xl animate-fade-in">
      <section className="mb-12">
        <h2 className="text-2xl font-semibold text-center mb-2 text-teal-300">Các Con Số Nổi Bật Hôm Nay</h2>
        <p className="text-center text-gray-400 mb-6 max-w-2xl mx-auto">{analysis.summary}</p>
