...
export const ViewToggle: React.FC<ViewToggleProps> = ({ view, setView }) => {
  const baseClasses = "px-3 sm:px-4 md:px-6 py-2 text-xs sm:text-sm font-semibold rounded-full transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 whitespace-nowrap";
  const activeClasses = "bg-blue-600 text-white shadow-md";
  const inactiveClasses = "bg-gray-700 text-gray-300 hover:bg-gray-600";

  return (
    <div className="flex items-center justify-center p-1 bg-gray-800 rounded-full mb-6 sm:mb-8 shadow-inner mx-2 sm:mx-0">
      <button
